      ...
      const main = async () => {
        try {
            ...
            let info = await transporter.sendMail({
                ...
                <p>We wanted to take a moment to express our deepest gratitude for joining us on this incredible journey.</p> 
                
                <p> Your contribution and dedication to sharing your travel experiences are the very foundation upon which our movement is built. Thank you for being an essential part of Vybes.</p>
                <br />
